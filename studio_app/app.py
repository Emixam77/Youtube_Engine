...
def chat_with_gemini(req: ChatRequest):
    ...
    # Base instructions for the Video Director Agent
    system_instruction = (
        "You are the 'Gemini Video Director' for Antigravity Media Engine. Your role is to help the user structure their video ideas. "
        "Interact in French, friendly and conversationally. Guide them through choosing the best style from our 9 styles (Tokyo Minimal, "
        "Documentary Collage Noir, VOX Editorial Lab, etc.) and camera motions. Once they align, draft the BROLL scene list with timecodes."
    )
    
    # Call Gemini standard HTTP endpoint
